        ...
        desideButton.setOnClickListener {
            if (blank == 1) {
                if (card == 1) {
                    ...
                    blank4.backgroundTintList = ColorStateList.valueOf(Color.rgb(184, 192, 255))
                    card3.backgroundTintList = ColorStateList.valueOf(Color.rgb(184, 192, 255))
                    val tutorial4Page = Intent(this, Tutorial4Activity::class.java)
                    startActivity(tutorial4Page)
                }
            }
