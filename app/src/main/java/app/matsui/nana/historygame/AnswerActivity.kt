...
class AnswerActivity : AppCompatActivity() {
    ...
    var answers = arrayOf(Triple("1560","桶狭間の戦い","織田信長が今川義元を破る"), Triple("1575","長篠の戦い","織田信長が鉄砲を有効活用して武田勝頼を破る"),
            ...
            Triple("1274","文永の役","元軍が日本に侵攻したが台風により撃退されたうちの1回目"),
            Triple("1281","弘安の役","元軍が日本に侵攻したが台風により撃退されたうちの2回目"),
            Triple("1853","ペリー来航","アメリカのペリー提督が江戸湾に来航し、日本を開国させるきっかけを作った"),
            Triple("1868","明治維新","明治政府が始まり、尊王攘夷派と開国派の対立が起こった"),
            Triple("1894","日清戦争","日本と清の間で行われた戦争"),
            Triple("1923","関東大震災","関東地方で発生した大地震と火災により多くの人命と建物が失われた"))
