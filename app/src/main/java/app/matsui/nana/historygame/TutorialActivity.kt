        ...
        desideButton.setOnClickListener {
            if (blank == 1) {
                if (card == 1) {
                    ...
                    blank3.backgroundTintList = ColorStateList.valueOf(Color.rgb(184, 192, 255))
                    card2.backgroundTintList = ColorStateList.valueOf(Color.rgb(184, 192, 255))
                    val tutorial2Page = Intent(this, Tutorial2Activity::class.java)
                    startActivity(tutorial2Page)
                }
            }
