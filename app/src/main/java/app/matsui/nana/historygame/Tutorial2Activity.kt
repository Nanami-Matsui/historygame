        ...
        desideButton.setOnClickListener {
            if (blank == 1) {
                if (card == 1) {
                    ...
                    blank1.backgroundTintList = ColorStateList.valueOf(Color.rgb(184, 192, 255))
                    card1.backgroundTintList = ColorStateList.valueOf(Color.rgb(184, 192, 255))
                    val tutorial3Page = Intent(this, Tutorial3Activity::class.java)
                    startActivity(tutorial3Page)
                }
            }
